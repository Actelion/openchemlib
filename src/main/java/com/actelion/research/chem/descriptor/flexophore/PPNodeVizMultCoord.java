 ...
 */
public class PPNodeVizMultCoord extends PPNodeViz {

    MultCoordFragIndex multCoordFragIndex;

    public PPNodeVizMultCoord(PPNodeViz node, MultCoordFragIndex multCoordFragIndex) {
        super(node);
