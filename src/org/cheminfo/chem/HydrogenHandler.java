...
public class HydrogenHandler {
	...
	public static void expandHydrogensAtAtom(StereoMolecule molecule, int iAtom) {
	...
	public static void expandAllHydrogens(StereoMolecule molecule) {
		molecule.ensureHelperArrays(2);
		int nAtomsBefore = molecule.getAllAtoms();
		for (int iAtom = 0; iAtom < nAtomsBefore; iAtom++) {
			expandHydrogensAtAtom(molecule, iAtom);
		}
		molecule.ensureHelperArrays(2);
	}
