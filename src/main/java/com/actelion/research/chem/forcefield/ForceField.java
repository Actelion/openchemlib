...
public abstract class ForceField   {
	...
	public ForceField(StereoMolecule mol) {	
	...
	public abstract double getTotalEnergy(double[] pos);
	
	/**
	 * updates the gradient of the ForceField and returns the gradient scale
	 * @return 
	 */
	public abstract double updateGradient();
	
	public abstract double[] getCurrentPositions();
	
	public abstract double[] getCurrentPositionsMapped(); //remaps the order of the coordinates to originally submitted ones, before the reordering by ensureHelperArrays
    ...
    private int run_minimiser(int maxIts,
    	double gradTol,
    	double funcTol) {
